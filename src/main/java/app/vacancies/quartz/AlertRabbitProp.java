 ...
 * Добавлена в файл app.properties настройки для базы данных.
 * 2. Создана sql schema с таблицей rabbit и полем created_date.
 * 3. При старте приложения создается connect к базе и передайте его в Job.
 * 4. В Job делается запись в таблицу, когда выполнена Job.
